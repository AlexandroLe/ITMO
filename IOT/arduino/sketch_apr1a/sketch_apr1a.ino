...
// ====== EDIT THESE VALUES ======
const char* WIFI_SSID = "Alexandro";
const char* WIFI_PASSWORD = "2003alex";

const char* BACKEND_HOST = "10.249.8.34";
const uint16_t BACKEND_PORT = 8080;

const char* DEVICE_ID = "nodemcu-02";
const char* DEVICE_TOKEN = "WK_TpYwr6qQUvD0X__JzJ2EO269W23IiLO5CowutSGo";
// =================================
